...
o();//▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓  
console.log("	Метод includes(string, index)")
// Метод используется для поиска одной строки в другой
...
// Метод принимает необязательный второй параметр с начальной
// позицией для поиска.
  var str = "Hi, I am a JS Developer";
...
o();//▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓  
console.log("	Метод startsWith(string,index)")
{
// Метод startsWith () используется для проверки, начинается ли 
// строка с другой строки, возвращая true или false,
// в зависимости от результата. 
  var str = "Hi, I am a JS Developer";
  console.log(str.startsWith('Hi, I am')); // Выведет "true"
// Метод принимает необязательный второй параметр с начальной
// позицией в строке для проверки.
  var str = "Hi, I am a JS Developer";
console.log(str.startsWith('JS Developer', 11)); // Выведет "true"
}

o();//▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓  
console.log("	Метод endsWith(string, index)")
{
// Метод endswith () используется для проверки, заканчивается ли
// строка другой строкой, возвращая true или false,
// в зависимости от результата. 
var str = "Hi, I am a JS Developer";
console.log(str.endsWith("JS Developer")); // Выведет "true"
// Метод также принимает
// необязательный второй параметр с позицией в строке для
// поиска, которая откладывается от конца строки
